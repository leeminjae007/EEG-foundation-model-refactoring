...
def main():
    parser = argparse.ArgumentParser(); parser.add_argument("--experiment", required=True, type=Path); parser.add_argument("--config", default="configs/pretrain_gr2_geometry.yaml"); parser.add_argument("--preset", choices=("gr2-mjde-d4-geometry", "gr2-d2-static", "gr2-d2-patch-scalar", "gr2-d2-patch-dimension", "gr2-d2-patch-dimension-mask60")); parser.add_argument("--prepare-only", action="store_true")
    ...
    if args.preset == "gr2-d2-patch-dimension-mask60":
        config["masking"]["mask_ratio"] = 0.60
