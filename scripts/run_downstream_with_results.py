...
if __name__ == "__main__":
    ...
    subprocess.run([sys.executable, str(source / "scripts/experiment_results.py"), "--experiment", str(args.experiment), "--dataset", args.dataset, "--seed", str(args.seed), "--result", str(output / "result.json")], check=True)
