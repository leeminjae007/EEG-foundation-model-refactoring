...
if __name__ == "__main__":
    ...
    parser.add_argument("--no-incremental-publish", action="store_true")
    ...
    result = output / ("smoke_result.json" if args.smoke_batches else "result.json")
    ...
    if args.smoke_batches or args.no_incremental_publish:
        sys.exit(0)
