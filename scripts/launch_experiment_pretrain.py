...
parser.add_argument(
    "--preset",
    choices=("gr2-mjde-d4-geometry", "gr2-d2-static", "gr2-d2-patch-scalar", "gr2-d2-patch-dimension", "gr2-d2-patch-dimension-mask55", "gr2-d2-patch-dimension-mask60", "gr2-d4-patch-dimension-mask55", "gr2-d4-patch-dimension-mask60"),
...
PRESETS = {
    ...
    "gr2-d2-patch-dimension-mask55": "gr2-d2-patch-dimension-mask55",
    "gr2-d2-patch-dimension-mask60": "gr2-d2-patch-dimension-mask60",
    "gr2-d4-patch-dimension-mask55": "gr2-d4-patch-dimension-mask55",
    "gr2-d4-patch-dimension-mask60": "gr2-d4-patch-dimension-mask60",
}
