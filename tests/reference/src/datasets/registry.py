...
from src.datasets.mumtaz_dataset import MumtazDataset
from src.datasets.physio_dataset import PhysioDataset
from src.datasets.seedv_dataset import SEEDVDataset
from src.datasets.seedvig_dataset import SEEDVIGDataset
...
DATASET_SPECS = {
    ...
    "speech": DatasetSpec(SpeechDataset, "multiclass", 5, 64, 600),
