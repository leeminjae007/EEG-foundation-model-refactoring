...
train_dir = '/gpfs/data/oermannlab/users/ml10266/Data/raw/bcic2020-3/Training set'
val_dir = '/gpfs/data/oermannlab/users/ml10266/Data/raw/bcic2020-3/Validation set'
test_dir = '/gpfs/data/oermannlab/users/ml10266/Data/raw/bcic2020-3/Test set'
...
db = lmdb.open('/gpfs/data/oermannlab/users/ml10266/Data/eeg_foundation_downstream/bcic2020-3/processed', map_size=3000000000)
...
df = pd.read_excel("/gpfs/data/oermannlab/users/ml10266/Data/raw/bcic2020-3/Test set/Track3_Answer Sheet_Test.xlsx")
df_=df.head(53)
