...
rootDir = '/gpfs/data/oermannlab/users/ml10266/Data/raw/mumtaz'
...
db = lmdb.open('/gpfs/data/oermannlab/users/ml10266/Data/eeg_foundation_downstream/mumtaz', map_size=1273741824)
