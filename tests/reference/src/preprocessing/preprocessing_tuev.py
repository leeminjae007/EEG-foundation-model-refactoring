...
target = "/gpfs/data/oermannlab/users/ml10266/Data/eeg_foundation_downstream/tuh_eeg_events"
...
root = "/gpfs/data/oermannlab/users/ml10266/Data/eeg_foundation_downstream/tuh_eeg_events"
# seed = 4523
# np.random.seed(seed)
