...
if __name__ == '__main__':
    setup_seed(1)
    file_path_list = iter_files('/gpfs/data/oermannlab/users/ml10266/Data/raw/tuh_eeg/tuh_eeg/edf')

    file_path_list = sorted(file_path_list)
    random.shuffle(file_path_list)
    # print(file_path_list)
    db = lmdb.open(
        r'/gpfs/data/oermannlab/users/ml10266/workspace/EEG-founation-model/processed/tuh_eeg',
        map_size=1649267441664,
    )
    file_key_list = []
