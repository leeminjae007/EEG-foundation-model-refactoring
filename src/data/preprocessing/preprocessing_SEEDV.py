...
root_dir = '/gpfs/data/oermannlab/users/ml10266/Data/raw/seed-v/files'
...
output_dir = '/gpfs/data/oermannlab/users/ml10266/workspace/EEG-founation-model/processed/SEED-V'
os.makedirs(output_dir, exist_ok=True)
db = lmdb.open(os.path.join(output_dir, 'processed'), map_size=15614542346)

for file in files:
    data_format = 'int32' if file == '7_1_20180411.cnt' else 'auto'
