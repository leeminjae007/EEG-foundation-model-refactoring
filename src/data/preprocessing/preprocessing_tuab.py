...
if __name__ == "__main__":
    ...
    root = "/gpfs/data/oermannlab/users/ml10266/Data/raw/tuh_eeg/tuh_eeg_abnormal/v3.0.1/edf"
    target = "/gpfs/data/oermannlab/users/ml10266/workspace/EEG-founation-model/processed/tuh_eeg_abnormal"
    ...
    train_dump_folder = os.path.join(target, "train")

    if not os.path.exists(os.path.join(target, "val")):
        os.makedirs(os.path.join(target, "val"))
    val_dump_folder = os.path.join(target, "val")

    if not os.path.exists(os.path.join(target, "test")):
        os.makedirs(os.path.join(target, "test"))
    test_dump_folder = os.path.join(target, "test")
