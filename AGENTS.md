...
- The `gr2-d2-patch-dimension-mask60` main candidate also uses A100 for both production pretraining and downstream, per the user's explicit request. Its diagnostic smoke may use L40S.
