...
- The `gr2-d4-patch-dimension-mask55` and `gr2-d4-patch-dimension-mask60` candidates use A100 for both production pretraining and downstream, per the user's explicit request. Their diagnostic smoke defaults to A100 but may use L40S when explicitly selected.
